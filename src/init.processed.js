...
/***/ (function(module, exports, __webpack_require__) {
	...
	// 20.2.2.17 Math.hypot([value1[, value2[, a€| ]]])
	var $export = __webpack_require__(8);
	var abs = Math.abs;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _musicApp = __webpack_require__(327);

	var _musicApp2 = _interopRequireDefault(_musicApp);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

		ReactDOM.render(React.createElement(_musicApp2.default, null), document.getElementById('root'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _topBar = __webpack_require__(328);

	var _topBar2 = _interopRequireDefault(_topBar);

	var _soundWaves = __webpack_require__(329);

	var _particles = __webpack_require__(330);

	var _particles2 = _interopRequireDefault(_particles);

	var _controlBar = __webpack_require__(332);

	var _controlBar2 = _interopRequireDefault(_controlBar);

	var _loading = __webpack_require__(333);
	...
	var MusicApp = function (_React$Component) {
	  ...
	  function MusicApp(props) {
	    ...
	    _this.setSongEnded = _this.setSongEnded.bind(_this);
	    _this.restartSong = _this.restartSong.bind(_this);
	    _this.setDraggingTime = _this.setDraggingTime.bind(_this);
	    _this.setOverridePercentage = _this.setOverridePercentage.bind(_this);
	    _this.handleMouseMove = _this.handleMouseMove.bind(_this);
	    _this.handleMouseAway = _this.handleMouseAway.bind(_this);
	    _this.setAudioTime = _this.setAudioTime.bind(_this);
	    _this.setDefaultAudioSettings = _this.setDefaultAudioSettings.bind(_this);
	    ...
	    _this.state = {
	      ...
	      tCount: 0,
	      nLines: nLines,
	      waves: [{ id: "wave-1", nLines: nLines, wHeight: 150, wWidth: 5, duration: 150, range: { start: 0.1, end: 0.3 }, peakFreq: 5 }, { id: "wave-2", nLines: nLines, wHeight: 150, wWidth: 5, duration: 150, range: { start: 0.6, end: 0.9 }, peakFreq: 5 }, { id: "wave-3", nLines: nLines, wHeight: 50, wWidth: 7, duration: 100, range: { start: 0, end: 1 }, peakFreq: 7 }],
	      audio: null,
	  ...
	  _createClass(MusicApp, [{
	    ...
	    value: function initAudio() {
	      ...
	      var audio = new Audio('https://s3-us-west-2.amazonaws.com/s.cdpn.io/1468070/SimonMoreAlive.mp3');
	      if (audio) {
	        try {
	          audio.addEventListener('loadedmetadata', function () {
	            setTimeout(function () {
	              audio.muted = _this2.state.mute;
	              audio.play();
	              _this2.setState({ audio: audio, tCount: Math.round(audio.duration), loading: false });
	              _this2.restartSong();
	            }, 1000);
	          });
	          audio.addEventListener('error', function () {
	            _this2.setDefaultAudioSettings();
	          });
	        } catch (err) {
	    ...
	    value: function setDefaultAudioSettings() {
	      this.setState({ tCount: 240, isPlaying: true, loading: false });
	    }
	  }, {
	    key: 'togglePlaying',
	    value: function togglePlaying(isPlaying) {
	      if (this.state.audio) {
	        if (isPlaying) {
	    ...
	    value: function handleMouseMove(e) {
	      if (this.state.isDraggingTime) {
	        var percentage = Math.round((e.clientX / window.innerWidth).toFixed(2) * 100);
	        this.setOverridePercentage(percentage);
	      }
	    }
	  }, {
	    key: 'handleMouseAway',
	    value: function handleMouseAway() {
	      this.setDraggingTime(false);
	    }
	  }, {
	    key: 'setDraggingTime',
	    value: function setDraggingTime(isDraggingTime) {
	      this.setState({ isDraggingTime: isDraggingTime });
	    }
	  }, {
	    key: 'setOverridePercentage',
	    value: function setOverridePercentage(percentage) {
	      this.setState({ overridePercentage: percentage });
	    }
	  }, {
	    key: 'setAudioTime',
	    value: function setAudioTime(time) {
	      if (this.state.audio) {
	    ...
	    value: function render() {
	      return React.createElement(
	        'div',
	        { id: 'music-app', onMouseMove: this.handleMouseMove, onMouseUp: this.handleMouseAway, onMouseLeave: this.handleMouseAway },
	        React.createElement(_loading2.default, { loading: this.state.loading }),
	        React.createElement(_topBar2.default, { title: this.state.title }),
	        React.createElement(_soundWaves.SoundWaves, {
	        ...
	        React.createElement(_particles2.default, {
	          isPlaying: this.state.isPlaying,
	          loading: this.state.loading,
	          isDraggingTime: this.state.isDraggingTime
	        }),
	        React.createElement(_controlBar2.default, {
...
/***/ (function(module, exports) {
	...
	var SoundWaves = function SoundWaves(_ref) {
	  ...
	  var soundWaves = waves.map(function (wave) {
	    return React.createElement(SoundWave, {
	      id: wave.id,
	      key: wave.id,
	  ...
	  return React.createElement(
	    'div',
	    { id: 'sound-waves', className: loading ? '' : 'visible' },
	    soundWaves
	  );
	};
	  ...
	  _createClass(SoundWave, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var _props = this.props,
	          ...
	          peakFreq = _props.peakFreq;

	      this.setLineHeights(true, false);
	      setInterval(function () {
	        var up = _this2.state.interval % 2 === 0,
	            bump = _this2.state.interval % peakFreq === 0;
	        _this2.setLineHeights(up, bump);
	        _this2.setState({ interval: ++_this2.state.interval });
	      }, duration);
	    }
	  }, {
	    key: 'getNearestInterval',
	    value: function getNearestInterval(interval, number, start) {
	      var offset = start ? 0 : -1;
	      return Math.ceil(number / interval) * interval + offset;
	    }
	  }, {
	    key: 'setLineHeights',
	    value: function setLineHeights(up, bump) {
	      var _props2 = this.props,
	          nLines = _props2.nLines,
	          wHeight = _props2.wHeight,
	          wMinHeight = _props2.wMinHeight,
	          wWidth = _props2.wWidth,
	          range = _props2.range,
	      ...
	      this.setState({ lineHeights: lineHeights });
	    }
	  }, {
	    key: 'getSoundLines',
	    value: function getSoundLines() {
	      var lines = [];
	      var _props3 = this.props,
	          nLines = _props3.nLines,
	          interval = _props3.interval;

	      for (var i = 0; i < nLines; i++) {
	        var style = { height: this.state.lineHeights[i] + 'px' },
	            line = React.createElement('div', { key: i, className: 'sound-line', style: style });
	        lines.push(line);
	      }
	      return lines;
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Particles = function (_React$PureComponent) {
	  _inherits(Particles, _React$PureComponent);

	  function Particles() {
	    _classCallCheck(this, Particles);

	    return _possibleConstructorReturn(this, (Particles.__proto__ || Object.getPrototypeOf(Particles)).apply(this, arguments));
	  }
	  ...
	  _createClass(Particles, [{
	    ...
	    value: function render() {
	      var _props = this.props,
	          ...
	          isDraggingTime = _props.isDraggingTime,
	          loading = _props.loading;

	      var particles = [],
	          nParticles = window.innerWidth / 8;
	      for (var i = 0; i < nParticles; i++) {
	        var left = (0, _util.getRand)(1, window.innerWidth),
	            height = (0, _util.getRand)(40, 60),
	            delay = (0, _util.getRand)(0, 1000),
	            duration = isDraggingTime ? (0, _util.getRand)(100, 400) : (0, _util.getRand)(500, 1500),
	            direction = (0, _util.getRand)(1, 1000),
	            size = (0, _util.getRand)(1, 1000),
	            pathStyle = {
	          height: height + 'px',
	          left: left + 'px',
	        ...
	        particles.push(React.createElement(
	          'div',
	          { key: i, className: 'particle-path', style: pathStyle },
	          React.createElement('div', { className: 'particle', style: particleStyle })
	        ));
	      }
	      return React.createElement(
	        'div',
	        { id: 'particles', className: loading ? '' : 'visible' },
	        particles
	      );
	    }
	  }]);
...
/***/ (function(module, exports) {
	...
	var getTime = function getTime(count) {
	  var applyZeros = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
	...
	var getRand = function getRand(min, max) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ControlBar = function (_React$Component) {
	  ...
	  function ControlBar(props) {
	    ...
	    _this.setDraggingTime = _this.setDraggingTime.bind(_this);
	    _this.getCountFromPercentage = _this.getCountFromPercentage.bind(_this);
	    _this.handlePercentageOverride = _this.handlePercentageOverride.bind(_this);
	    _this.state = {
	      count: 0,
	      interval: null
	    };
	  ...
	  _createClass(ControlBar, [{
	    ...
	    value: function componentDidUpdate(prevProps, prevState) {
	      if (prevProps.isPlaying !== this.props.isPlaying) {
	        if (!this.props.isPlaying) this.stopTime();else this.startTime();
	      }
	    }
	  }, {
	    key: 'startTime',
	    value: function startTime() {
	      ...
	      var interval = setInterval(function () {
	        _this2.setState({ count: ++_this2.state.count });
	      }, 1000);
	    ...
	    key: 'getCountFromPercentage',
	    value: function getCountFromPercentage() {
	    ...
	    value: function getPercentage() {
	      if (this.props.isDraggingTime) {
	        ...
	        if (this.props.overridePercentage >= 0) {
	          var _percentage = this.props.overridePercentage;
	          this.handlePercentageOverride();
	          return _percentage;
	        } else if (this.props.end) {
	          return 100;
	        }
	        var percentage = this.state.count / this.props.tCount * 100;
	        return Math.min(percentage, 100);
	      }
	    }
	  }, {
	    key: 'handlePercentageOverride',
	    value: function handlePercentageOverride() {
	      var count = this.getCountFromPercentage();
	    ...
	    value: function render() {
	      ...
	      var percentage = this.getPercentage(),
	          ...
	          currTime = (0, _util.getTime)(time, false),
	          endTime = (0, _util.getTime)(this.props.tCount, false),
	          _props = this.props,
	          isPlaying = _props.isPlaying,
	          ...
	          _restartSong = _props.restartSong,
	          setSongEnded = _props.setSongEnded,
	          end = _props.end;
	      ...
	      var classNames = isDraggingTime ? 'dragging' : '';
	      return React.createElement(
	        'div',
	        { id: 'control-bar', className: classNames },
	        React.createElement(ProgressBar, { percentage: percentage, setDraggingTime: this.setDraggingTime }),
	        React.createElement(PlayToggle, { isPlaying: isPlaying, togglePlaying: togglePlaying, end: end }),
	        React.createElement(Restart, { restartSong: function restartSong() {
	            _restartSong();
	            _this3.setState({ count: 0 });
	          } }),
	        React.createElement(Volume, { mute: mute, toggleMute: toggleMute }),
	        React.createElement(Time, { time: currTime, endTime: endTime })
	      );
	    }
	  }]);
	...
	var ProgressBar = function ProgressBar(_ref) {
	  var percentage = _ref.percentage,
	      setDraggingTime = _ref.setDraggingTime;
	  return React.createElement(
	    'div',
	    { id: 'progress-bar', className: 'button' },
	    React.createElement(
	      'div',
	      { id: 'filled', style: { width: percentage + '%' } },
	      React.createElement('div', { id: 'dragger', onMouseDown: function onMouseDown() {
	...
	var PlayToggle = function PlayToggle(_ref2) {
	  var isPlaying = _ref2.isPlaying,
	      togglePlaying = _ref2.togglePlaying,
	      end = _ref2.end;
	  return React.createElement(
	    'div',
	    { id: 'play-toggle', className: isPlaying ? "button toggled" : "button", onClick: function onClick() {
	        if (!end) {
	...
	var Restart = function Restart(_ref3) {
	  var restartSong = _ref3.restartSong;
	  return React.createElement(
	    'div',
	    { id: 'restart', className: 'button', onClick: restartSong },
	    React.createElement('i', { className: 'fa fa-undo' })
	  );
	};

	var Volume = function Volume(_ref4) {
	  var mute = _ref4.mute,
	      toggleMute = _ref4.toggleMute;
	  return React.createElement(
	    'div',
	    { id: 'volume-toggle', className: mute ? "button toggled" : "button", onClick: function onClick() {
	        toggleMute(!mute);
	      } },
	    React.createElement(
	      'div',
...
/***/ (function(module, exports) {
	...
	var Loading = function (_React$Component) {
	  ...
	  _createClass(Loading, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var classNames = this.props.loading ? 'visible' : 'done';
	      if (this.state.hide) classNames = classNames + ' hide';

	      return React.createElement(
	        'div',
	        { id: 'loading', className: classNames },
	        React.createElement(
	          'div',
	          { id: 'bars' },
...
/***/ })
/******/ ]);
//# sourceMappingURL=init.processed.js.map